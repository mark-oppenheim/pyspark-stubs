...
class SQLContext:
    ...
    # @overload
    # def createDataFrame(self, data: pandas.core.frame.DataFrame, samplingRatio: Optional[float] = ...) -> DataFrame: ...
    # @overload
    # def createDataFrame(self, data: pandas.core.frame.DataFrame, schema: Union[StructType, str], verifySchema: bool = ...) -> DataFrame: ...
